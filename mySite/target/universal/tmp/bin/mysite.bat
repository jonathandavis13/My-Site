@REM mysite launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM MYSITE_config.txt found in the MYSITE_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%MYSITE_HOME%"=="" set "MYSITE_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%MYSITE_HOME%\lib\"
...
set "CFG_FILE=%MYSITE_HOME%\MYSITE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running mysite.
  echo.
